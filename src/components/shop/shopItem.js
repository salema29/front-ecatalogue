const ShopItem = ({ shopId, shopImage, shopTitle, shopAdress, clientColor }) => {
    ...
    return (
        <div className="shop-item" style={shopItemStyle}>
            <div className="shop-picture" style={{ width: "fit-content", height: "fit-content" }}><img style={{ width: "60.86px", height: "60.86px", backgroundSize: "cover", borderRadius: "50%" }} src={shopImage} alt="shop"></img></div>
            <div className="shop-info" style={{ margin: "0 10px", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
                ...
                <div className="shop-info-address" style={{ display: "flex", alignItems: "center" }}>
                    ...
                    <div className="shop-info-address-value" style={{ fontSize: "12px" }}>
                        {shopAdress.length > 35 ? shopAdress.slice(0, 35) + '...' : shopAdress}
                    </div>
                </div>
            </div>
